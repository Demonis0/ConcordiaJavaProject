...
public class AddPatient extends Frame implements ActionListener{
    ...
    AddPatient(){
        ...
        em=new TextField();
        em.setBounds((int) Math.ceil(Constants.xSize*0.05)+200,15+5*Constants.ySize/20,170,20);
        ...
        b.setBounds((int) Math.ceil(Constants.xSize*0.05),8*Constants.ySize/20,80,30);
        Label l6 = new Label("*: Must be filled");
        l6.setBounds((int) Math.ceil(Constants.xSize*0.05), 9*Constants.ySize/20, 200, 50);
        add(b);
        add(l6);
